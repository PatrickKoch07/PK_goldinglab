...
%       p.minCellArea = 30;
      p.minCellArea = 200; %Tommy Sep 23, 2008
    end
...
%       p.minCellLength = 30;
      p.minCellLength = 60; %Tommy Sep 23, 2008
    end
    if ~isfield(p,'maxCellWidth')
%       p.maxCellWidth = 7;
      p.maxCellWidth = 30; %Tommy Sep 23, 2008
    end
...
%       p.minNumEdgePixels = 250;  % JCR: value used for nature methods paper
      p.minNumEdgePixels = 280; %Tommy Sep 23, 2008
    end
...
%     savelist=['''phsub'',''LNsub'',''rect'',''timestamp'',''phaseFullSize'''];
    savelist=['''LN'',''phsub'',''LNsub'',''rect'',''timestamp'',''phaseFullSize'',''ph''']; %Tommy, Sep 23, 2008
